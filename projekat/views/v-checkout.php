        ...
        <div class="row">
            <div class="col-6 mb-5">
                <form class="p-4" action="./checkout-page.php" method="post" style="border: solid black 2px; border-radius: 2%;">
                    ...
                    <button type="submit" class="btn btn-primary mt-5 mb-5" name="buy" value="yes">Buy</button>
            ...
            <div class="col-6">
                        ...
                        <?php foreach ($items as $item) { ?>
                            ...
                            <div class="item-container row">
                                ...
                                <div class="col-8">
                                    ...
                                    <p class="text-info">Price: <?php echo htmlspecialchars($item->getProduct()->price); ?> dinara</p>
                                    <p class="text-info">Quantity: <?php echo htmlspecialchars($item->getQuantity()); ?></p>
                                    <p class="text-info">Price with quantity: <?php echo htmlspecialchars($subtotal); ?> dinara</p>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <h2 class="text-primary"><?php echo htmlspecialchars($total); ?> dinara</h2>
                </div>
            </div>
        </div>
    </div>
